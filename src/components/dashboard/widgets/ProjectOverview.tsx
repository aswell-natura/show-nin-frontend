...
export default function ProjectOverview() {
  ...
  return (
    <StandardWidget
      ...
      stats={[
        { label: '全案件', value: projects.length },
        { label: '進行中', value: activeCount },
        { label: '未紐付け', value: unlinkedCount, valueClassName: 'text-red-600 dark:text-red-400', className: 'bg-red-50/50 dark:bg-red-900/10 border-red-100 dark:border-red-900/30' },
      ]}
